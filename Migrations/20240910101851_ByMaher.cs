...
{
    /// <inheritdoc />
    public partial class ByMaher : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogUserLikes", x => new { x.UserId, x.BlogId });
                    table.ForeignKey(
                        name: "FK_BlogUserLikes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_BlogUserLikes_Blogs_BlogId",
                        column: x => x.BlogId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "42de0cd0-981f-43a4-9c18-bb6a86e98864", "44d9d556-88ba-4ba5-bb25-f8b9053fe907", "Admin", "ADMIN" },
                    { "80ad2485-097e-42ec-a1d6-fbd9b7df73c5", "4159241d-a096-4eaf-ad03-c6fce2d5d2a2", "Freelancer", "FREELANCER" },
                    { "a34c34e3-31e0-4aa9-aea4-ac00790c50fc", "6e2b5f5a-d3aa-4612-a4b9-383436e2030a", "Client", "CLIENT" }
                });
